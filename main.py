...
cap = cv2.VideoCapture("Test Videos/samplevideo.mp4")
        ...
        if len(pts) >= 4:
            ...
            if center_x is not None and center_y is not None:
                ...
                if inside_polygon((center_x, center_y), np.array([pts])) and name == 'person':
                    ...
                    cv2.putText(frame, "Person Detected", (40, 40), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
                    cv2.rectangle(frame, (x1, y1), (x2, y2), (0, 0, 255), 3)
                    print("CONSOLE LOG - PERSON DETECTED")
                    count += 1
